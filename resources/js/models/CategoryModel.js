// Category Model for mapping API response
export class CategoryModel {
    ...
    // Static method to map single category
    static fromApiResponse(apiData) {
        return new CategoryModel(apiData);
    }

    // Static method to map array of categories
    static fromApiResponseArray(apiDataArray) {
        ...
        return apiDataArray.map(item => CategoryModel.fromApiResponse(item));
    }
