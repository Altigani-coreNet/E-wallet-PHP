...
export default function CustomerCreate() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await post(API_ENDPOINTS.CUSTOMERS.CREATE, submitData);
            
            if (response.data.success !== false) {
                // Navigate back to customers list immediately
                window.location.href = '/merchant/sales/customers';
            } else {
                setErrors({ general: response.data.message || 'Failed to create customer' });
                setLoading(false);
            }
            ...
            if (err.response?.data?.errors) {
                ...
                setErrors({
                    general: err.response?.data?.message || 'Failed to create customer'
                });
            }
            setLoading(false);
        }
                ...
                <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                    ...
                    <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li className="breadcrumb-item text-gray-900">Create</li>
                        </ul>
                    </div>
