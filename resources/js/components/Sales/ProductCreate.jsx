...
import { post, get, getToken } from '../../utils/api';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const submitData = {
                ...
                product_images: formData.product_images.map(img => img.url),
            };
            ...
            const response = await post(API_ENDPOINTS.PRODUCTS.CREATE, submitData);

            if (response.data.success !== false) {
                // Clear products list cache so it refreshes
                sessionStorage.removeItem('products_list_cache');
                ...
                <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                    <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li className="breadcrumb-item"><span className="bullet bg-gray-500 w-5px h-2px"></span></li>
                            <li className="breadcrumb-item text-muted">Add</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div className="card card-flush py-4">
                                ...
                                <div className="card-body pt-0">
                                    ...
                                    <div className="text-muted fs-7 mt-2">
                                        Select the type of product to determine its behavior
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card card-flush py-4">
                                ...
                                <div className="card-body pt-0">
                                    ...
                                    <div className="mb-5">
                                        ...
                                        <div className="text-muted fs-7 mt-1">Hold Ctrl/Cmd to select multiple</div>
                                    </div>
