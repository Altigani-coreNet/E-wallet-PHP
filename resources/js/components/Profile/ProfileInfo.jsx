    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            ...
            if (profileForm.profile_image) {
                await profileAPI.uploadProfileImage(profileForm.profile_image);
            }
                            ...
                            <form onSubmit={handleProfileSubmit}>
                                ...
                                <div className="card-footer d-flex justify-content-end py-6 px-9">
                                    <button type="submit" className="btn btn-primary" disabled={updating}>
                                        <span className={`indicator-label ${updating ? 'd-none' : ''}`}>
                                            Update Profile
                                        </span>
                                        <span className={`indicator-progress ${updating ? '' : 'd-none'}`}>
                                            Please wait... 
                            ...
                            <form onSubmit={handlePasswordSubmit}>
                                ...
                                <div className="card-footer d-flex justify-content-end py-6 px-9">
                                    <button type="submit" className="btn btn-primary" disabled={changingPassword}>
                                        <span className={`indicator-label ${changingPassword ? 'd-none' : ''}`}>
                                            Change Password
                                        </span>
                                        <span className={`indicator-progress ${changingPassword ? '' : 'd-none'}`}>
                                            Please wait... 
                                            <span className="spinner-border spinner-border-sm align-middle ms-2"></span>
                                        </span>
                                    </button>
