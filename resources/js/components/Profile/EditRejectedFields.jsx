...
const EditRejectedFields = ({ merchant, onSuccess, onCancel }) => {
    ...
    const fetchRejectedFields = async () => {
        try {
            setLoading(true);
            const response = await axios.get('/api/softpos/merchant-profile/rejected-fields');
            
            console.log('✅ Rejected fields response:', response.data);
            
            if (response.data.success) {
                const { merchant: merchantData, rejection: rejectionData, attachments: attachmentsData } = response.data.data;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                '/api/softpos/merchant-profile/update-rejected-fields',
                submitData,
                {
                    headers: {
