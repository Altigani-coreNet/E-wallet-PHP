...
@section('title', __('translation.edit_terminal'))
...
@section('breadcrumbs')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">{{ __('translation.edit_terminal') }}</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">{{ __('translation.edit_terminal') }}</h3>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" value="{{ old('name', $terminal->name) }}" required>
                        @error('name')
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('terminal_id') is-invalid @enderror" 
                               id="terminal_id" name="terminal_id" value="{{ old('terminal_id', $terminal->terminal_id) }}" 
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('brand') is-invalid @enderror" 
                               id="brand" name="brand" value="{{ old('brand', $terminal->brand) }}" 
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('model') is-invalid @enderror" 
                               id="model" name="model" value="{{ old('model', $terminal->model) }}">
                        @error('model')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('manufacturer') is-invalid @enderror" 
                               id="manufacturer" name="manufacturer" value="{{ old('manufacturer', $terminal->manufacturer) }}">
                        @error('manufacturer')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('serial_no') is-invalid @enderror" 
                               id="serial_no" name="serial_no" value="{{ old('serial_no', $terminal->serial_no) }}">
                        @error('serial_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('sdk_id') is-invalid @enderror" 
                               id="sdk_id" name="sdk_id" value="{{ old('sdk_id', $terminal->sdk_id) }}">
                        @error('sdk_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('sdk_version') is-invalid @enderror" 
                               id="sdk_version" name="sdk_version" value="{{ old('sdk_version', $terminal->sdk_version) }}">
                        @error('sdk_version')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('android_os') is-invalid @enderror" 
                               id="android_os" name="android_os" value="{{ old('android_os', $terminal->android_os) }}" 
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control @error('add_type') is-invalid @enderror" 
                            ...
                            <option value="static" {{ old('add_type', $terminal->add_type) == 'static' ? 'selected' : '' }}>
                                {{ __('translation.static') }} ({{ __('translation.manual_addition') }})
                            </option>
                            <option value="auto" {{ old('add_type', $terminal->add_type) == 'auto' ? 'selected' : '' }}>
            ...
            {{-- <div class="row">
                <div class="col-md-6">
                    <x-select-options 
                        ...
                        :value="old('is_active', $terminal->is_active ? 'active' : 'inactive')"
                    />
                    @error('is_active')
