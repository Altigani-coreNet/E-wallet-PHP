...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title>Corenet Tech - Advanced Payment & POS Solutions</title>
		<meta charset="utf-8" />
		<meta name="description" content="Corenet Tech offers comprehensive payment processing, POS management, and banking solutions for modern businesses. Accept payments anywhere, manage your business everywhere." />
		<meta name="keywords" content="payment processing, POS system, banking solutions, merchant services, payment gateway, credit card processing, digital payments, SEPA, ACH, multi-currency" />
				...
				<div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/illustrations/landing.svg)">
					...
					<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
						...
						<div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
							<!--begin::Title-->
							<h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">Transform Your Business with
							<br />
							<span style="background: linear-gradient(to right, #20AA3E 0%, #03A588 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">Advanced Payment Solutions</span>
							</span></h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fs-6 text-white opacity-75 mb-8">Comprehensive payment processing, POS management, and banking solutions.<br>Accept payments anywhere, manage your business everywhere.</p>
							<!--end::Description-->
							<!--begin::Action-->
							<a href="{{ route('merchant.register') }}" class="btn btn-light btn-lg me-3">Start Free Trial</a>
