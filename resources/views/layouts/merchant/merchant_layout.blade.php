...
<head>
    <base href="../" />
    <title>@yield('main-head', 'Corenet Tech Merchant Dashboard')</title>
    <meta charset="utf-8" />
    <meta name="description" content="@yield('meta_description', 'Corenet Tech Merchant Dashboard - Point of Sale Management System')" />
    <meta name="keywords" content="@yield('meta_keywords', 'corenet tech, pos, merchant, dashboard, point of sale')" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="@yield('og_title', 'Corenet Tech Merchant Dashboard')" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            @include('layouts.merchant.partials.header')
           
            <!--end::Header-->
            <!--begin::Wrapper-->
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                @include('layouts.merchant.partials.sidebar')
                <!--begin::Main-->
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    <!--begin::Content wrapper-->
                    <div class="d-flex flex-column flex-column-fluid">
                        @if(empty($has_toolbar))
                            @include('layouts.merchant.partials.toolbar')
                        @endif
                        <!--begin::Content-->
                    ...
                    <!--end::Content wrapper-->
                    @include('layouts.merchant.partials.footer')
                </div>
                <!--end:::Main-->
            </div>
            <!--end::Wrapper-->
    ...
    <!--end::App-->
    @include('layouts.merchant.partials.drawers')
    <!--begin::Scrolltop-->
    ...
    <!--end::Scrolltop-->
    @include('layouts.merchant.partials.modals')
    <!--begin::Javascript-->
    <script>
