            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img 
                        src="{{ auth()->guard('admin')->user()->profile_image ? asset(auth()->guard('admin')->user()->profile_image) : asset('assets/media/avatars/300-1.jpg') }}"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ auth()->guard('admin')->user()->profile_image ? asset(auth()->guard('admin')->user()->profile_image) : asset('assets/media/avatars/300-1.jpg') }}">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
