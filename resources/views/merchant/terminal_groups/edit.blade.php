...
@section('main-head', 'Edit Terminal Group')
...
@section('breadcrumbs')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">{{ __('translation.edit_terminal_group') }}</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('content')
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div id="terminal-group-edit-form-root" data-terminal-group="{{ json_encode($terminalGroup) }}"></div>
        </div>
        <!--end::Container-->
    </div>
@endsection
