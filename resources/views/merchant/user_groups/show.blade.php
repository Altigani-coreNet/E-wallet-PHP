...
<div class="d-flex align-items-center gap-2 gap-lg-3">
    <div class="m-0">
        <a href="{{ route('merchant.user-groups.edit', $userGroup) }}" class="btn btn-primary me-3">
        ...
        <a href="{{ route('merchant.user-groups.index') }}" class="btn btn-light-danger">
                                        ...
                                        <tbody>
                                            @foreach($userGroup->users as $user)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <a href="{{ route('merchant.users.show', $user->id) }}" class="btn btn-sm btn-light-primary">
                                                            View
                                                        </a>

                                                        <form action="{{ route('merchant.user-groups.remove-user', [$userGroup->id, $user->id]) }}" method="POST" onsubmit="return confirm('Remove this user from the group?');">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <a href="{{ route('merchant.user-groups.edit', $userGroup) }}" class="btn btn-warning">
                                    <i class="ki-duotone ki-pencil fs-2">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                ...
                                <form action="{{ route('merchant.user-groups.toggle-status', $userGroup->id) }}" method="POST">
                                    @csrf
                                ...
                                <form action="{{ route('merchant.user-groups.destroy', $userGroup->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
