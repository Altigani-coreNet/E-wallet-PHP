@if(auth()->user()->can('users_groups') || auth()->user()->can('view_users_groups') || auth()->user()->can('edit_users_groups') || auth()->user()->can('delete_users_groups'))
<div class="d-flex justify-content-end flex-shrink-0">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
        ...
        <div class="menu-item px-3">
            <a href="{{ route('merchant.user-groups.show', ['user_group' => $group->id]) }}" class="menu-link px-3">
                View
            </a>
        </div>
        <!--end::Menu item-->
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <form action="{{ route('merchant.user-groups.toggle-status', $group->id) }}" method="POST" style="display: inline;">
                @csrf
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="{{ route('merchant.user-groups.edit', $group->id) }}" class="menu-link px-3">
                Edit
            </a>
        </div>
        <!--end::Menu item-->
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <form action="{{ route('merchant.user-groups.destroy', $group->id) }}" method="post">
                @csrf
                @method('DELETE')
