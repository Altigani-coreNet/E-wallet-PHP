    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    @if($user->logo_url)
                        <img src="{{ $user->logo_url }}" alt="User Logo" class="rounded">
                    @else
                        ...
                        <div class="me-0">
                            ...
                            {{-- <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <a href="{{ route('profile.edit', $user->id) }}" class="menu-link px-3">
                                        {{ __('translation.edit') }}
                                    </a>
                                </div>
                            </div> --}}
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-100px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="{{ $user->merchant->branches_count ?? 0 }}">
                                        {{ $user->merchant->branches_count ?? 0 }}
                                    </div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('translation.branches') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-100px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="{{ $user->merchant->terminals_count ?? 0 }}">
                                        {{ $user->merchant->terminals_count ?? 0 }}
                                    </div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('translation.terminals') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-100px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="{{ $user->merchant->users_count ?? 1 }}">
                                        {{ $user->merchant->users_count ?? 1 }}
                                    </div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-100px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bolder counted" data-kt-countup="true" data-kt-countup-value="{{ $user->merchant->transactions_count ?? 0 }}">
                                        {{ $user->merchant->transactions_count ?? 0 }}
                                    </div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('translation.transactions') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                        </div>
                    ...
                    <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                        ...
                        <div class="text-center w-100">
                            @php
                                ...
                                $statusClass = $statusClasses[$user->merchant->status] ?? 'badge-light-warning';
                                ...
                                $statusLabels = [
                                    ...
                                    'requesting_updated' => __('translation.requesting_updated'),
                                ];
                                $statusLabel = $statusLabels[$user->merchant->status] ?? $user->merchant->status;
                            @endphp
                            <button type="button" class="btn btn-sm {{ $statusClass }} px-9 py-4">
                                <span class="indicator-label">
                                    {{ ucfirst($statusLabel) }}
                                </span>
                                @if($user->merchant->status === 'pending' || $user->merchant->status === 'viewed')
                                    <span class="indicator-progress">
                                        <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                    </span>
                                @endif
                            </button>
                            @if($user->merchant->status === 'rejected' && $user->merchant->rejection_reason)
                                <div class="mt-2">
                                    <span class="text-danger fs-8" data-bs-toggle="tooltip" title="{{ $user->merchant->rejection_reason }}">
                                        <i class="bi bi-info-circle me-1"></i>{{ Str::limit($user->merchant->rejection_reason, 30) }}
                                    </span>
                                </div>
                            @endif
                         </div>
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-nav-line-tabs mb-5 fs-6">
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ $activeTab === 'profile' ? 'active' : '' }}" 
                   href="{{ route('merchant.profile') }}">
                    {{ __('translation.merchant_profile') }}
                </a>
            </li>
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ $activeTab === 'user_info' ? 'active' : '' }}" 
                   href="{{ route('profile.user_info') }}">
                    {{ __('translation.user_info') }}
                </a>
            </li>
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ $activeTab === 'events' ? 'active' : '' }}" 
                   href="{{ route('profile.events') }}">
