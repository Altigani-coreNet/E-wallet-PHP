    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        <div class="d-flex flex-lg-row-fluid">
            <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                ...
                <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">Corenet Tech Admin Panel</h1>
                <div class="text-gray-600 fs-base text-center fw-semibold">Manage your business efficiently with our comprehensive admin panel.</div>
            </div>
        </div>
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        <form class="form w-100" method="POST" action="{{ route('admin.login') }}">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <div class="text-gray-500 fw-semibold fs-6">Enter your admin credentials</div>
                            </div>
