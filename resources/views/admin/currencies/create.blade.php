...
<li class="breadcrumb-item text-gray-600">Create Currency</li>
@endsection
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" name="name" class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" 
                           value="{{ old('name') }}" placeholder="Enter currency name" required>
                    @error('name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-6">
                <div class="col-lg-6">
                    ...
                    <input type="text" name="symbol[en]" class="form-control form-control-lg form-control-solid @error('symbol.en') is-invalid @enderror" 
                           value="{{ old('symbol.en') }}" placeholder="Enter currency symbol in English (e.g., $)" required>
                    @error('symbol.en')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-6">
                <div class="col-lg-6">
                    ...
                    <input type="text" name="symbol[ar]" class="form-control form-control-lg form-control-solid @error('symbol.ar') is-invalid @enderror" 
                           value="{{ old('symbol.ar') }}" placeholder="Enter currency symbol in Arabic" required>
                    @error('symbol.ar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" name="currency_code[en]" class="form-control form-control-lg form-control-solid @error('currency_code.en') is-invalid @enderror" 
                           value="{{ old('currency_code.en') }}" placeholder="Enter currency code in English (e.g., USD)" required>
            ...
            <div class="row mb-6">
                <div class="col-lg-6">
                    ...
                    <input type="text" name="currency_code[ar]" class="form-control form-control-lg form-control-solid @error('currency_code.ar') is-invalid @enderror" 
                           value="{{ old('currency_code.ar') }}" placeholder="Enter currency code in Arabic" required>
