...
<li class="breadcrumb-item text-gray-600">Edit City</li>
@endsection
            ...
            <div class="row mb-6">
                <div class="col-lg-6">
                    ...
                    <input type="text" name="name[en]" class="form-control form-control-lg form-control-solid @error('name.en') is-invalid @enderror" 
                           value="{{ old('name.en', $city->getTranslation('name', 'en')) }}" placeholder="Enter city name in English" required>
                    @error('name.en')
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" name="name[ar]" class="form-control form-control-lg form-control-solid @error('name.ar') is-invalid @enderror" 
                           value="{{ old('name.ar', $city->getTranslation('name', 'ar')) }}" placeholder="Enter city name in Arabic" required>
                    @error('name.ar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <span class="indicator-label">Update City</span>
                        </button>
                    </div>
                </div>
            </div>
