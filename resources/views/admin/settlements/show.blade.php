...
@section('main-head' , __('translation.settlement_details'))
@section('breadcrumb')
@section('breadcrumbs')
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.settlements.index') }}" class="text-muted text-hover-primary">{{ __('translation.settlements') }}</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item">
...
<div class="d-flex align-items-center gap-2 gap-lg-3">
    @if($settlement->status === 'pending')
        <form action="{{ route('admin.settlements.mark-as-settled', $settlement) }}" method="POST" class="d-inline">
            @csrf
            <button type="submit" class="btn btn-sm fw-bold btn-success" 
                    onclick="return confirm('{{ __('translation.are_you_sure_mark_settled') }}')">
                <i class="ki-duotone ki-check fs-3">
                    <span class="path1"></span>
                    <span class="path2"></span>
                </i>
                {{ __('translation.mark_as_settled') }}
            </button>
        </form>
        
        <form action="{{ route('admin.settlements.mark-as-failed', $settlement) }}" method="POST" class="d-inline">
            @csrf
            <button type="submit" class="btn btn-sm fw-bold btn-danger" 
                    onclick="return confirm('{{ __('translation.are_you_sure_mark_failed') }}')">
                <i class="ki-duotone ki-cross fs-3">
                    <span class="path1"></span>
                    <span class="path2"></span>
                </i>
                {{ __('translation.mark_as_failed') }}
            </button>
        </form>
    @endif
    
    <a href="{{ route('admin.settlements.index') }}" class="btn btn-sm fw-bold btn-secondary">
                    ...
                    <div class="card card-flush h-100">
                        ...
                        <div class="card-body pt-2 pb-4 d-flex align-items-center flex-wrap">
                            <div class="d-flex flex-column flex-grow-1 pe-8">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <a href="{{ route('admin.batches.show', $settlement->batch) }}" class="btn btn-sm btn-light-primary">
                        ...
                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.transactions.show', $transaction) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
