...
<div id="kt_app_content_container" class="app-container container-xxl">
    ...
    <div class="row gy-5 g-xl-10 mb-5">
        ...
        <div class="col-xl-3 mb-xl-10">
            <div class="card card-flush h-xl-100 cursor-pointer" onclick="window.location.href='{{ route('merchants.index') }}'">
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-gray-800">Total Merchants</span>
                        <span class="text-gray-500 mt-1 fw-semibold fs-6">Active merchants count</span>
                    </h3>
                </div>
                <div class="card-body pt-2">
                    <div class="mb-2">
                        <span class="fs-2hx fw-bold d-block text-gray-800 me-2 mb-2 lh-1 ls-n2">{{ number_format($totalMerchants ?? 0) }}</span>
                    </div>
                </div>
            </div>
        </div>
        <!--begin::Users Count-->
        <div class="col-xl-3 mb-xl-10">
            <div class="card card-flush h-xl-100 bg-light-info cursor-pointer" onclick="window.location.href='{{ route('users.index') }}'">
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
        ...
        <div class="col-xl-3 mb-xl-10">
            <div class="card card-flush h-xl-100 bg-light-warning cursor-pointer" onclick="window.location.href='{{ route('terminals.index') }}'">
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
        ...
        <div class="col-xl-3 mb-xl-10">
            <div class="card card-flush h-xl-100 bg-light-primary cursor-pointer" onclick="window.location.href='{{ route('admin.transactions.index') }}'">
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
    ...
    <div class="row gy-5 gx-xl-10">
        ...
        <div class="col-xl-4 mb-xl-10">
            ...
            <x-charts.top-selling-merchants />
            <!--end::Chart widget 5-->
        </div>
        <!--end::Col-->
        <!--begin::Col-->
