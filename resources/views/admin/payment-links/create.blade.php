...
@section('main-head', __('translation.add_payment_link'))
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('admin.payment-links.index') }}"
                class="text-muted text-hover-primary">{{ __('translation.payment_links') }}</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-500 w-5px h-2px"></span>
        </li>
        <li class="breadcrumb-item text-muted">{{ __('translation.add_payment_link') }}</li>
    </ul>
@endsection
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
            <div class="row g-5 g-xl-8 mt-4">
                <!-- Existing empty row, can be removed or left as is -->
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header border-0 pt-6 d-flex justify-content-between align-items-center">
                            <div class="card-title">
                                <h3 class="card-label">{{ __('translation.add_payment_link') }}</h3>
                            </div>
                            {{-- <div class="card-toolbar">
                                <button type="button" id="demo-bank-url" class="btn btn-info">Demo Bank URL</button>
                            </div> --}}
                        </div>
                        <form id="payment-link-form" action="{{ route('admin.payment-links.store') }}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        @php
                                            ...
                                            $paymentMethodTypes = old('payment_method_types', []);
                                            if (!is_array($paymentMethodTypes)) {
                                                $paymentMethodTypes = is_string($paymentMethodTypes) ? [$paymentMethodTypes] : [];
                                            }
                                        @endphp
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('scheduled_date') is-invalid @enderror" id="scheduled_date" name="scheduled_date" value="{{ old('scheduled_date') }}">
                        ...
                        <div class="card-footer p-3">
                                <button type="submit" class="btn btn-primary">{{ __('translation.add_payment_link') }}</button>
