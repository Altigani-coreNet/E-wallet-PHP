...
<li class="breadcrumb-item text-gray-600">Edit Country</li>
@endsection
            ...
            <div class="row mb-6">
                <div class="col-lg-6">
                    ...
                    <input type="text" name="name[en]" class="form-control form-control-lg form-control-solid @error('name.en') is-invalid @enderror" 
                           value="{{ old('name.en', $country->getTranslation('name', 'en')) }}" placeholder="Enter country name in English" required>
                    @error('name.en')
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" name="name[ar]" class="form-control form-control-lg form-control-solid @error('name.ar') is-invalid @enderror" 
                           value="{{ old('name.ar', $country->getTranslation('name', 'ar')) }}" placeholder="Enter country name in Arabic" required>
                    @error('name.ar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-6">
                <div class="col-lg-6">
                    ...
                    <input type="text" name="short_name" class="form-control form-control-lg form-control-solid @error('short_name') is-invalid @enderror" 
                           value="{{ old('short_name', $country->short_name) }}" placeholder="Enter short name (e.g., US, UK)" required>
                    @error('short_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" name="code" class="form-control form-control-lg form-control-solid @error('code') is-invalid @enderror" 
                           value="{{ old('code', $country->code) }}" placeholder="Enter country code (e.g., US, UK)">
                    @error('code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
