...
@section('main-head', 'Add Advertisement')
...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">Add Advertisement</li>
    </ul>
@endsection
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h3 class="fw-bold">Add Advertisement</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body pt-0">
                <form id="addAdvertisementForm" action="{{ route('admin.advertisements.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        url="{{route('countries.select')}}" required="true" />
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-6">
                        ...
                        <button type="submit" class="btn btn-primary" id="submitBtn">
                            <span class="indicator-label">Save Advertisement</span>
