                ...
                <div style="max-width: 1200px" class="modal-body pt-0 pb-15 px-5 px-xl-20 ">
                    ...
                    <div class="-body">
                        ...
                        <div class="card-px text-center pt-15 pb-15">
                            <!--begin::Title-->
                            <h2 class="fs-2x fw-bolder mb-0">There was an error in the payment.</h2>
                            <!--end::Title-->
                        ...
                        <div class="text-center pb-15 px-5 d-flex flex justify-center align-center">
                            <div class="mw-100 h-200px h-sm-325px">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     data-name="Layer 1" width="300.7" height="300.81" viewBox="0 0 1022.7 785.81">
                                    <defs>
                                        <linearGradient id="af83dc26-9572-4816-b7a1-1af4f72ff554-216" x1="678.2"
                                                        y1="821.79" x2="678.2" y2="493.4"
