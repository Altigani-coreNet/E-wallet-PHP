<div style="min-width: 100px">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
        <div class="menu-item px-3">
            <a href="{{ route('brands.edit', $id) }}" class="menu-link px-3">
                Edit
            </a>
        </div>
        <div class="menu-item px-3">
            <a href="{{ route('brands.show', ['status' => true , 'brand' => $id]) }}" class="menu-link px-3">
                Change Status
            </a>
        </div>
        <div class="menu-item px-3">
            <form action="{{ route('brands.destroy', $id) }}" method="post" style="display: inline-block; width: 100%;" id="delete-form-{{ $id }}">
                @csrf
                @method('delete')
