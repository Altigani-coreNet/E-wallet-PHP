...
@section('main-head' , ___('translation.main_categories_managements'))
@section('page_title',  'Categories Mangements')
@section('breadcrumbs')
    <!--begin::Breadcrumb-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <a href='{{ route('categories.create', ['type' => request()->type])}}'
                               class="btn btn-primary">{{ ___('translation.add_categories') }}</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="categories-table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="">{{ ___('translation.sub_categories_count') }}</th>
...
<script>
    ...
    let rolesTable = $('#categories-table').DataTable({
        dom: "tiplr",
        serverSide: true,
        processing: true,
        language: {
