...
class Utility extends Model
{
    ...
    public static $oldChartOfAccount1 = array(
    ...
    public static function oldChartOfAccountData1($user)
    {
    ...
    public static function settings()
    {
        ...
        $settings = [
            ...
            "company_address" => "Office 802, The Guardian Towers, Al Abyat St, Al Sa'adah, Abu Dhabi, U.A.E",
            "company_webiste" => "www.0g.ae",
            "company_city" => "Abu Dhabi",
            "company_state" => "",
            "company_zipcode" => "P.O. Box 107018, Abu Dhabi",
            "company_country" => "UAE",
            "company_telephone" => "+971 2 6272062",
            "company_trn" => "TRN 1000000000",
            "invoice_prefix" => "#INVO",
            "advance_prefix" => "#ADVA",
            "journal_prefix" => "#JUR",
    ...
    public static function invoiceNumberFormat($settings, $number)
    {
        ...
        $invoice = Invoice::where("invoice_id", $numberString)->where('created_by', \Auth::user()->creatorId())->first();
        ...
        return $settings["invoice_prefix"] . sprintf("%05d", (int) $numberString);
    ...
    public static function getTaxData()
    {
        ...
        if (self::$rates == null) {
            ...
            foreach (self::$rates as $rate) {
                ...
                $data[$rate->id]['tax_type'] = $rate->tax_type;
...
//        return ($taxRate / 100) * (($price-$discount) * $quantity);
    ...
    public static $sampleOfChartOfAccount = [
        [
            'code' => '1000',
            'name' => 'Assets',
            'type' => 'assets',
            'type_id' => 1,
            'sub_type' => 'Current Asset', // First from assets
            'sub_type_id' => 1,
            'parent' => null,
            'description' => 'Main category for all assets',
        ],
        ['code' => '1058', 'name' => 'Cash', 'type' => 'assets', 'type_id' => 1, 'sub_type' => 'Current Asset', 'sub_type_id' => 1, 'parent' => '1000', 'description' => 'Cash in hand and bank accounts'],
        ['code' => '1100', 'name' => 'Current Assets', 'type' => 'assets', 'type_id' => 1, 'sub_type' => 'Current Asset', 'sub_type_id' => 1, 'parent' => '1000', 'description' => 'Short-term assets'],
        ['code' => '1110', 'name' => 'Cash and Cash Equivalents', 'type' => 'assets', 'type_id' => 1, 'sub_type' => 'Current Asset', 'sub_type_id' => 1, 'parent' => '1100', 'description' => 'Cash in hand and bank accounts'],
        ['code' => '1120', 'name' => 'Accounts Receivable', 'type' => 'assets', 'type_id' => 1, 'sub_type' => 'Current Asset', 'sub_type_id' => 1, 'parent' => '1100', 'description' => 'Money owed by customers'],
    
        ['code' => '1200', 'name' => 'Fixed Assets', 'type' => 'assets', 'type_id' => 1, 'sub_type' => 'Non-current Asset', 'sub_type_id' => 3, 'parent' => '1000', 'description' => 'Long-term assets'],
        ['code' => '1210', 'name' => 'Machinery and Equipment', 'type' => 'assets', 'type_id' => 1, 'sub_type' => 'Non-current Asset', 'sub_type_id' => 3, 'parent' => '1200', 'description' => 'Manufacturing and operational equipment'],
    
        ['code' => '1510', 'name' => 'Inventory', 'type' => 'assets', 'type_id' => 1, 'sub_type' => 'Inventory Asset', 'sub_type_id' => 2, 'parent' => '1100', 'description' => 'Inventory of goods'],
        ...
        [
            ...
            'type' => 'liabilities',
            'type_id' => 2,
            'sub_type' => 'Current Liabilities', // First from liabilities
            'sub_type_id' => 1,
            'parent' => null,
            'description' => 'Main category for liabilities',
        ],
         ['code' => '2100', 'name' => 'Current Liabilities', 'type' => 'liabilities', 'type_id' => 2, 'sub_type' => 'Current Liabilities', 'sub_type_id' => 1, 'parent' => '2000', 'description' => 'Short-term liabilities'],
        ['code' => '2110', 'name' => 'Accounts Payable', 'type' => 'liabilities', 'type_id' => 2, 'sub_type' => 'Current Liabilities', 'sub_type_id' => 1, 'parent' => '2100', 'description' => 'Money owed to suppliers'],
        ['code' => '2200', 'name' => 'Long-term Liabilities', 'type' => 'liabilities', 'type_id' => 2, 'sub_type' => 'Long Term Liabilities', 'sub_type_id' => 2, 'parent' => '2000', 'description' => 'Debts payable after a year'],
        ['code' => '2150', 'name' => 'VAT Control', 'type' => 'liabilities', 'type_id' => 2, 'sub_type' => 'Current Liabilities', 'sub_type_id' => 1, 'parent' => '2100', 'description' => 'Value Added Tax (VAT) control account for both payables and refunds'],
        ...
        [
            ...
            'type' => 'equity',
            'type_id' => 3,
            'sub_type' => 'Equity', // First from equity
            'sub_type_id' => 1,
            'parent' => null,
            'description' => "Owner's interest in the business",
        ], ['code' => '3100', 'name' => 'Capital', 'type' => 'equity', 'type_id' => 3, 'sub_type' => 'Share Capital', 'sub_type_id' => 3, 'parent' => '3000', 'description' => "Owner's capital account"],
        ['code' => '3020', 'name' => 'Opening Balances and adjustments', 'type' => 'equity', 'type_id' => 3, 'sub_type' => 'Share Capital', 'sub_type_id' => 3, 'parent' => '3000', 'description' => "Owner's capital account"],
        ['code' => '3025', 'name' => 'Owner Contributions', 'type' => 'equity', 'type_id' => 3, 'sub_type' => 'Owners Equity', 'sub_type_id' => 2, 'parent' => '3000', 'description' => "Owner's capital account"],
        ['code' => '3035', 'name' => 'Retained Earnings', 'type' => 'equity', 'type_id' => 3, 'sub_type' => 'Retained Earnings', 'sub_type_id' => 4, 'parent' => '3000', 'description' => "Owner's capital account"],
        ['code' => '3040', 'name' => 'Owner Withdrawals', 'type' => 'equity', 'type_id' => 3, 'sub_type' => 'Owners Equity', 'sub_type_id' => 2, 'parent' => '3000', 'description' => "Owner's capital account"],
    
        ['code' => '4000', 'name' => 'Revenue', 'type' => 'income', 'type_id' => 4, 'sub_type' => 'Sales Revenue', 'sub_type_id' => 1, 'parent' => null, 'description' => 'Income from sales or services'],
        ['code' => '4100', 'name' => 'Sales Revenue', 'type' => 'income', 'type_id' => 4, 'sub_type' => 'Sales Revenue', 'sub_type_id' => 1, 'parent' => '4000', 'description' => 'Income from sales of products/services'],
        ...
        [
            ...
            'type' => 'expenses',
            'type_id' => 6,
            'sub_type' => 'Payroll Expenses', // First from expenses
            'sub_type_id' => 1,
            'parent' => null,
            'description' => 'Operating expenses',
        ],
         ['code' => '5100', 'name' => 'Cost of Goods Sold (COGS)', 'type' => 'expenses', 'type_id' => 5, 'sub_type' => 'Costs of Goods Sold', 'sub_type_id' => 1, 'parent' => '5000', 'description' => 'Cost of products sold'],
        ['code' => '5200', 'name' => 'Operating Expenses', 'type' => 'expenses', 'type_id' => 6, 'sub_type' => 'General and Administrative expenses', 'sub_type_id' => 2, 'parent' => '5000', 'description' => 'General operational expenses'],
        ['code' => '5210', 'name' => 'Salaries and Wages', 'type' => 'expenses', 'type_id' => 6, 'sub_type' => 'Payroll Expenses', 'sub_type_id' => 1, 'parent' => '5200', 'description' => 'Employee compensation'],
        ['code' => '5220', 'name' => 'Rent Expense', 'type' => 'expenses', 'type_id' => 6, 'sub_type' => 'General and Administrative expenses', 'sub_type_id' => 2, 'parent' => '5200', 'description' => 'Rent for office or factory space'],
        ['code' => '5300', 'name' => 'Utilities', 'type' => 'expenses', 'type_id' => 6, 'sub_type' => 'General and Administrative expenses', 'sub_type_id' => 2, 'parent' => '5200', 'description' => 'Electricity, water, and other utilities'],
    ];
    
    
    
// TODO:: NEw Chanrt Of Account 
...
public static $chartOfAccountSubType = array(
    ...
    public static $newChartOfAccount = array(
        [
            'code' => '1058',
            'name' => 'Cash',
            'type' => 1,
        ...
        [
            'code' => '1510',
            'name' => 'Accumulated Depreciation - Laptops',
            'type' => 7,
            'sub_type' => 16,
        ],
        [
        ...
        [
            'code' => '1550',
            'name' => 'Furniture and Fixtures - Vehicles',
            'type' => 7,
            'sub_type' => 16,
        ],
        [
        ...
        [
            'code' => '1840',
            'name' => 'Accumulated Depreciation – Mobile Phones',
            'type' => 7,
            'sub_type' => 16,
        ],
        ...
        [
            'code' => '3020',
            'name' => "Contribution (Partner's Contribution)",
            'type' => 9,
            'sub_type' => 21,
        ],
        [
        ...
        [
            'code' => '3030',
            'name' => "Partner's Current Account",
            'type' => 9,
            'sub_type' => 21,
        ],
        [
...
// chart of account for new company
    ...
    public static function chartOfAccountData2($user, $is_admin = false)
    {
        $chartOfAccounts = Self::$chartOfAccount;

        foreach ($chartOfAccounts as $account) {

            $type = ChartOfAccountType::where('created_by', $user->creatorId())->where('name', $account['type'])->first();
            ...
            $parentAccount = null;
            if(isset($account['parent']) && $account['parent']) {
                // Look up parent account by code (not ID) since parent field contains codes
                $parentChartAccount = ChartOfAccount::where('code', $account['parent'])->where('created_by', $user->creatorId())->first();
                
                if($parentChartAccount) {
                    $existingparentAccount = ChartOfAccountParent::where('name', $parentChartAccount->name)->where('created_by', $user->creatorId())->first();
                    
                    if ($existingparentAccount) {
                        $parentAccount = $existingparentAccount;
                    } else {
                        $parentAccount = new ChartOfAccountParent();
                        $parentAccount->name = $parentChartAccount->name;
                        $parentAccount->sub_type = $parentChartAccount->sub_type;
                        $parentAccount->type = $parentChartAccount->type;
                        $parentAccount->account = $parentChartAccount->id;
                        $parentAccount->created_by = $user->creatorId();
                        $parentAccount->save();
                    }
                }
            }
            ...
            if($parentAccount) {
                $chartOfAccountData['parent'] = $parentAccount->id;
            }
    ...
    {
        ChartOfAccount::where("created_by", $user->id)->delete();
...
//                    dd(\Storage::disk(),$path);
    ...
    public static function getAccountBalance($account_id, $start_date = null, $end_date = null)
    {
        ...
        $total = TransactionLines::
            select('chart_of_accounts.id', 'chart_of_accounts.code', 'chart_of_accounts.name', 'chart_of_account_types.name as type_name',
...
// 
        ...
        // dd();
        if(!empty($total[0]['type_name']) && $total[0]['type_name'] == 'Assets') {
    ...
    public static function getAccountData($account_id, $start_date = null, $end_date = null, $customer_id = null, $vendor_id = null)
    {
        if (!empty($start_date) && !empty($end_date)) {
            $start = $start_date;
            $end = $end_date;
        ...
        $q = DB::table('transaction_lines')
            ...
            ->leftJoin('credit_notes', function ($join) {
                $join->on('transaction_lines.reference_id', '=', 'credit_notes.id')
                    ->whereIn('transaction_lines.reference', ['Credit Note']);
            })
            ->leftJoin('debit_notes', function ($join) {
                $join->on('transaction_lines.reference_id', '=', 'debit_notes.id')
                    ->whereIn('transaction_lines.reference', ['DebitNote']);
            })
            ->leftJoin('advances', function ($join) {
                $join->on('transaction_lines.reference_id', '=', 'advances.id')
                    ->whereIn('transaction_lines.reference', ['Advance']);
            })
            ->leftJoin('journal_entries', function ($join) {
                $join->on('transaction_lines.reference_id', '=', 'journal_entries.id')
                    ->where('transaction_lines.reference', 'Journal');
            })
            ->leftJoin('customers as revenues_customers', 'revenues.customer_id', '=', 'revenues_customers.id')
            ->leftJoin('customers as credit_noted_customers', 'credit_notes.customer', '=', 'credit_noted_customers.id')
            ->leftJoin('customers as advances_customers', 'advances.customer_id', '=', 'advances_customers.id')
            ->leftJoin('venders as debit_notes_venders', 'debit_notes.vendor', '=', 'debit_notes_venders.id')
            ...
            ->select(
                ...
                DB::raw("COALESCE(customers.name, venders.name , revenues_customers.name , payments_venders.name, credit_noted_customers.name, debit_notes_venders.name, advances_customers.name) as user_name"),
                DB::raw("COALESCE(invoices.invoice_id, bills.bill_id, credit_notes.note_id, debit_notes.debit_note_id) as ids"),
                'journal_entries.journal_id as journal_entry_number',
            );

            if ($customer_id !== null && $customer_id !== '') {
                $q->whereIn('transaction_lines.reference', ['Invoice Payment', 'Invoice', 'Credit Note', 'Advance'])
                    ->where('transaction_lines.customer_id', $customer_id);
            }

            if ($vendor_id !== null && $vendor_id !== '') {
                $q->whereIn('transaction_lines.reference', ['Bill', 'Bill Payment', 'Bill Account', 'Expense', 'Expense Account', 'Expense Payment', 'Payment', 'DebitNote'])
                    ->where('transaction_lines.vendor_id', $vendor_id);
            }

           $transactionData = $q->get();
    ...
    public static function getAccountDataForAdmin($account_id, $start_date = null, $end_date = null, $customer_id = null, $companyies = []){
        ...
        $q = DB::table('transaction_lines')
            ...
            ->select(
                ...
                'bills.vender_id as vendor_id',
                'chart_of_accounts.name as account_name',
                DB::raw("COALESCE(customers.name, venders.name , revenues_customers.name , payments_venders.name, credit_noted_customers.name, debit_notes_venders.name) as user_name"),
                DB::raw("COALESCE(invoices.invoice_id, bills.bill_id, credit_notes.note_id, debit_notes.debit_note_id) as ids"),
            );

            if ($customer_id !== null) {
                $q->whereIn('transaction_lines.reference', ['Invoice Payment', 'Invoice', 'Credit Note'])
                    ->where('transaction_lines.customer_id', $customer_id);
            }

            if(count($companyies) > 0){
                $q->whereIn('transaction_lines.created_by', $companyies);
            }
    ...
    public static function addTransactionLines($data, $new = null)
    {
        ...
        $transactionLines->customer_id = $data['customer_id'] ?? null;
        $transactionLines->vendor_id = $data['vendor_id'] ?? null;
